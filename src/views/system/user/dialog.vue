			...
			<el-row :gutter="35">
				...
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					<el-form-item label="关联角色" prop="role_id">
						<el-select v-model="state.ruleForm.role_id" placeholder="请选择" clearable class="w100">
							<el-option v-for="item in state.roles" :key="item.id" :label="item.name"
				...
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					<el-form-item label="部门" prop="dept_id">
						<el-cascader :options="state.depts"
							:props="{ checkStrictly: true, emitPath: false, value: 'id', label: 'name' }"
							placeholder="请选择部门" clearable filterable class="w100" v-model="state.ruleForm.dept_id">
				...
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					<el-form-item label="账户过期" prop="expire_time">
						<el-date-picker v-model="state.ruleForm.expire_time" type="date" placeholder="请选择" class="w100">
						</el-date-picker>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
...
const onSubmit = async (formEl: FormInstance | undefined) => {
	...
	await formEl!.validate(async (valid) => {
		if (valid) {
			if (props.id) {
				updateUser(props.id, state.ruleForm).then(() => {
